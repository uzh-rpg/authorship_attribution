...
import sys
import os
from CustomDistilBertForSequenceClassification import CustomDistilBertForSequenceClassification
...
if (LOAD_TOKENIZED_DATA_FROM_FILE):
    ...
    new_df['reference_count_embeddings'] = reference_count_embeddings.values.tolist()
